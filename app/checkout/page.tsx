      ...
      <form onSubmit={onSubmit} className="grid md:grid-cols-2 gap-4">
        ...
        <div className="md:col-span-1 card-base p-4 h-max">
          ...
          <p className="text-sm text-slate-600 leading-7">
            لطفا اطلاعات روبرو را کامل کنید و محصول در سریع ترین زمان ممکن
            براتون پست خواهد شد.
            <span className="block text-slate-700 font-semibold mt-3">
              *اگر مشکل یا مورد خاصی دارید لطفا در قسمت یادداشت وارد کنید
            </span>
          </p>
        </div>
      </form>
